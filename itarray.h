...
/*
  this function receives a list of pointers to closed itemsets (array of
  ITArrays) generated by mpi workers and merges them in one final ITArray.
  Cs is a pointer to an array of valid pointers to ITArrays,
  size is the number of ITArrays.
  The merged result will be stored in C. C will be initialized by this function
*/
